...
2. **Gemma 4 31B** (~19 GB) — Best quality. Slower. Can be overkill.
3. **Gemma 4 E2B** (~2 GB) — Smallest, fastest download. Good for a quick test or older laptops.
...
- **Gemma 4 chat model:** 2 GB (E2B), 18 GB (26B), or 19 GB (31B) — your choice
